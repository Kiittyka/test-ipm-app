...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-1zhgit89pp1">Show
  modal</button>

<div data-modal id="modal-1zhgit89pp1" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-1zhgit89pp1-label" aria-describedby="modal-1zhgit89pp1-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1zhgit89pp1-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1zhgit89pp1-heading">Modal heading</p>
