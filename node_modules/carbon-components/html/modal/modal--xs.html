...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-o8qc7nco9q">Show
  modal</button>

<div data-modal id="modal-o8qc7nco9q" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-o8qc7nco9q-label" aria-describedby="modal-o8qc7nco9q-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-o8qc7nco9q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-o8qc7nco9q-heading">Modal heading</p>
