...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-evp79d5ukgu">Show
  modal</button>

<div data-modal id="modal-evp79d5ukgu" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-evp79d5ukgu-label" aria-describedby="modal-evp79d5ukgu-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-evp79d5ukgu-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-evp79d5ukgu-heading">Modal heading</p>
