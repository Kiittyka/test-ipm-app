...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-761zam6xxd">Show
  modal</button>

<div data-modal id="modal-761zam6xxd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-761zam6xxd-label" aria-describedby="modal-761zam6xxd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-761zam6xxd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-761zam6xxd-heading">Modal heading</p>
