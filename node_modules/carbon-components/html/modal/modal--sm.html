...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-sfi03khcsy">Show
  modal</button>

<div data-modal id="modal-sfi03khcsy" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-sfi03khcsy-label" aria-describedby="modal-sfi03khcsy-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sfi03khcsy-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sfi03khcsy-heading">Modal heading</p>
