...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-0rsb729u7whs">Show
  modal</button>

<div data-modal id="modal-0rsb729u7whs" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-0rsb729u7whs-label" aria-describedby="modal-0rsb729u7whs-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-0rsb729u7whs-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-0rsb729u7whs-heading">Modal heading</p>
