...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kn7t0jutd3">Show
  modal</button>

<div data-modal id="modal-kn7t0jutd3" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kn7t0jutd3-label" aria-describedby="modal-kn7t0jutd3-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kn7t0jutd3-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kn7t0jutd3-heading">Modal heading</p>
