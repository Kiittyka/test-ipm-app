...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-gi5a75wudk">Show
  modal</button>

<div data-modal id="modal-gi5a75wudk" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-gi5a75wudk-label" aria-describedby="modal-gi5a75wudk-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-gi5a75wudk-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-gi5a75wudk-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
