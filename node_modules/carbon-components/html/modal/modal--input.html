...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-xbw4tw7c8se">Show
  modal</button>

<div data-modal id="modal-xbw4tw7c8se" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-xbw4tw7c8se-label" aria-describedby="modal-xbw4tw7c8se-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-xbw4tw7c8se-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-xbw4tw7c8se-heading">Modal heading</p>
    ...
    <div class="bx--modal-content bx--modal-content--with-form" >
      <div class="bx--form-item">
        <label for="text-input-xbw4tw7c8se" class="bx--label">Text Input label</label>
        <input id="text-input-xbw4tw7c8se" type="text" class="bx--text-input" placeholder="Optional placeholder text"
