...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-cvqieqoka7p">Show
  modal</button>

<div data-modal id="modal-cvqieqoka7p" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-cvqieqoka7p-label" aria-describedby="modal-cvqieqoka7p-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-cvqieqoka7p-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-cvqieqoka7p-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
